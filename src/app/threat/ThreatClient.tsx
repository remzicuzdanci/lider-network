...
const STEPS = [
  {
    n: "1", icon: "🔌",
    title: "External Connector oluşturun",
    body: "FortiGate yönetim arayüzünde üst menüden Security Fabric → External Connectors yolunu izleyin. Açılan ekranda sağ üst köşedeki Create New butonuna tıklayın. Çıkan listeden Threat Feeds kategorisi altında feed türünü seçin:",
    list: [
      "Domain Name — zararlı alan adları için",
      "IP Address — zararlı IPv4 adresleri için",
      "URL — zararlı bağlantılar için",
    ],
    urls: null,
    tip: "Her feed türü için ayrı bir connector oluşturmanız gerekir. Toplamda 3 connector açacaksınız.",
  },
  {
    n: "2", icon: "🔗",
    title: "Feed URL'sini ve yenileme süresini girin",
    body: "Connector oluştururken aşağıdaki alanları doldurun:",
    list: [
      "Name: Tanımlayıcı bir isim girin (örn. LiderNet-Domain, LiderNet-IP, LiderNet-URL)",
      "URI: Aşağıdaki tablodaki ilgili URL'yi yapıştırın",
      "Refresh Rate: 60 (dakika)",
      "Status: Enabled",
      "OK ile kaydedin — durum yeşil olmalı",
    ],
    urls: [
    ...
    tip: "FortiGate 30G / 40F / 60F gibi düşük bellekli cihazlar için yukarıdaki URL'ler yerine Lite Feed sekmesindeki 90 günlük URL'leri kullanın.",
  },
  {
    n: "3", icon: "🌐",
    title: "DNS Filter — domain feed'ini engelleyin",
    body: "Zararlı alan adlarının DNS seviyesinde engellenmesi için Security Profiles → DNS Filter yoluna gidin. Mevcut profilinizi düzenleyin veya Create New ile yeni bir profil oluşturun. Profil içinde şu ayarları yapın:",
    list: [
      "DNS Filter bölümünde External Feed Entries → + Add",
      "Açılan listeden 'LiderNet-Domain' connector'ını seçin",
      "Action sütununu Block olarak ayarlayın",
      "Profili kaydedin — oluşturduğunuz profil adını not alın",
    ],
    urls: null,
    tip: "DNS Filter, alan adı sorgusu yapılır yapılmaz engeller — zararlı siteye bağlantı kurulmadan önce durdurur.",
  },
  {
    n: "4", icon: "🔒",
    title: "Web Filter — URL feed'ini engelleyin",
    body: "Zararlı URL'lerin HTTP/HTTPS seviyesinde engellenmesi için Security Profiles → Web Filter yoluna gidin. Mevcut profilinizi düzenleyin veya yeni profil oluşturun. URL Filter bölümünde:",
    list: [
      "URL Filter → Create butonuna tıklayın",
      "Type: External Resource Feed seçin",
      "External Feed: 'LiderNet-URL' connector'ını seçin",
      "Action: Block",
      "Enable: işaretli olmalı",
      "Kaydedip profil adını not alın",
    ],
    urls: null,
    tip: "Web Filter, DNS'i atlayan ya da IP üzerinden erişen bağlantılara karşı ek koruma katmanı sağlar.",
  },
  {
    n: "5", icon: "🚫",
    title: "IP engelleme — Firewall Policy kuralı oluşturun",
    body: "Zararlı IP adreslerine giden trafiği kesmek için Policy & Objects → Firewall Policy → Create New yolunu izleyin:",
    list: [
      "Name: Threat-IP-Block",
      "Incoming Interface: iç ağ arayüzünüz (örn. LAN, port2)",
      "Outgoing Interface: WAN arayüzünüz",
      "Source: all",
      "Destination → + Create → External Resource → 'LiderNet-IP' connector'ını seçin",
      "Schedule: always",
      "Service: ALL",
      "Action: DENY",
      "Log Violation Traffic: Enable → kaydedin",
    ],
    urls: null,
    tip: "Bu kuralı policy listesinde Allow kurallarının ÜSTÜNE taşıyın. Aksi hâlde kural devreye girmeyebilir.",
  },
  {
    n: "6", icon: "🛡",
    title: "Güvenlik profillerini mevcut Policy'e bağlayın",
    body: "İnternet erişim kuralınızı (LAN → WAN, Action: Allow) düzenleyin. Security Profiles bölümünde oluşturduğunuz profilleri atayın:",
    list: [
      "DNS Filter → Adım 3'te oluşturduğunuz profili seçin",
      "Web Filter → Adım 4'te oluşturduğunuz profili seçin",
      "SSL/SSH Inspection: certificate-inspection (HTTPS trafiği için)",
      "OK ile kaydedin",
    ],
    urls: null,
    tip: "Kayıt sonrası FortiGate feed'leri otomatik çekmeye başlar. İlk yüklemede 5–10 dakika beklemeniz gerekebilir. Security Fabric → External Connectors ekranında connector durumu yeşil görünüyorsa kurulum tamamdır.",
  },
];

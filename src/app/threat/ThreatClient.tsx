...
const STEPS = [
  ...
  {
    n: "2", icon: "🌐",
    title: "DNS Filter — domain ve URL feed'lerini ekleyin",
    body: "Security Profiles → DNS Filter → mevcut profilinizi düzenleyin veya Create New. DNS Filter bölümünde External Feed Entries → + Add ile iki connector'ı da ekleyin:",
    list: [
      "LIDER-DOMAIN connector'ını seçin → Action: Block",
      "LIDER-URL connector'ını seçin → Action: Block",
      "Profili kaydedin ve adını not alın",
    ],
    urls: null,
    tip: "URL connector'ı Web Filter'da görünmez — DNS Filter'a ayrıca eklenmesi gerekir. Her iki connector da burada Block olarak tanımlanmalıdır.",
  },
  {
    n: "3", icon: "🔒",
    title: "Web Filter — URL feed'ini ekleyin",
    body: "Security Profiles → Web Filter → mevcut profilinizi düzenleyin veya Create New. URL Filter bölümünde:",
    list: [
      "Create butonuna tıklayın → Type: Simple",
      "URL alanına threat.lidernetwork.com.tr/feeds/url.txt yazın",
      "Action: Block → Enable: işaretli",
      "Profili kaydedin ve adını not alın",
    ],
    urls: [
      "https://threat.lidernetwork.com.tr/feeds/url.txt",
    ],
    tip: "Web Filter URL'yi doğrudan okur, connector seçimi yerine URL'yi manuel olarak gireceksiniz.",
  },
  {
    n: "4", icon: "🚫",
    title: "IP engelleme — Firewall Policy kuralı oluşturun",
    body: "Policy & Objects → Firewall Policy → Create New ile zararlı IP'lere giden trafiği kesin:",
    list: [
      "Name: THREAT-IP-BLOCK",
      "Incoming Interface: iç ağ arayüzünüz (LAN / port2 vb.)",
      "Outgoing Interface: WAN",
      "Source: all",
      "Destination → + → External Resource → LIDER-IP connector'ını seçin",
      "Action: DENY — Log Violation Traffic: Enable",
      "Kaydedin ve policy listesinde Allow kurallarının ÜSTÜNE taşıyın",
    ],
    urls: null,
    tip: "Kural sırası kritiktir — DENY kuralı Allow kuralının altında kalırsa devre dışı kalır.",
  },
  {
    n: "5", icon: "🛡",
    title: "DNS ve Web Filter profillerini Policy'e bağlayın",
    body: "Mevcut internet erişim kuralınızı (LAN → WAN, Action: Allow) düzenleyin. Security Profiles bölümünde:",
    list: [
      "DNS Filter → Adım 2'de kaydettiğiniz profili seçin",
      "Web Filter → Adım 3'te kaydettiğiniz profili seçin",
      "SSL/SSH Inspection: certificate-inspection",
      "OK ile kaydedin",
    ],
    urls: null,
    tip: "Kayıt sonrası FortiGate feed'leri otomatik çekmeye başlar. External Connectors ekranında kartlar yeşil görünüyorsa kurulum tamamdır. İlk yüklemede 5–10 dakika gecikme olabilir.",
  },
];
